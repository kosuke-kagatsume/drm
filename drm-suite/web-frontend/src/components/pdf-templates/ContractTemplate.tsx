    ...
    <Document>
      <Page size="A4" style={styles.page}>
        ...
        <View style={styles.header}>
          <Text style={styles.title}>工事請負契約書 / CONTRACT</Text>
        </View>
        ...
        <View style={styles.headerInfo}>
          ...
          <View style={styles.customerSection}>
            <Text style={styles.infoLabel}>発注者 / Client:</Text>
            <Text style={styles.companyName}>{contract.customerCompany}</Text>
            <Text style={styles.infoValue}>{contract.customerName} 様</Text>
            <Text style={styles.infoValue}>{contract.customerAddress}</Text>
            {contract.customerPhone && (
              <Text style={styles.infoValue}>
                TEL: {contract.customerPhone}
              </Text>
            )}
          </View>
        </View>
        ...
        <View style={styles.invoiceDetails}>
          <View style={styles.detailsRow}>
            <Text style={styles.detailLabel}>契約書番号:</Text>
            <Text style={styles.detailValue}>{contract.contractNo}</Text>
          </View>
          <View style={styles.detailsRow}>
            <Text style={styles.detailLabel}>契約日:</Text>
            <Text style={styles.detailValue}>
              {formatDate(contract.contractDate)}
            </Text>
          </View>
          <View style={styles.detailsRow}>
            <Text style={styles.detailLabel}>工期:</Text>
            <Text style={styles.detailValue}>
              {formatDate(contract.startDate)} 〜 {formatDate(contract.endDate)}
            </Text>
          </View>
          <View style={styles.detailsRow}>
            <Text style={styles.detailLabel}>工事名:</Text>
            <Text style={styles.detailValue}>{contract.projectName}</Text>
          </View>
        </View>
        ...
        <View style={styles.summarySection}>
          <View style={styles.summaryTable}>
            ...
            <View style={styles.summaryRowTotal}>
              <Text style={styles.summaryLabel}>請負金額 (Total)</Text>
              <Text style={styles.summaryValue}>
        ...
        {contract.paymentSchedule && contract.paymentSchedule.length > 0 && (
          <View style={styles.footer}>
            <Text style={styles.footerTitle}>支払条件 / Payment Schedule</Text>
        ...
        {contract.warrantyPeriod && (
          <View style={styles.footer}>
            <Text style={styles.footerTitle}>保証期間 / Warranty Period</Text>
            <Text style={styles.footerText}>{contract.warrantyPeriod}</Text>
          </View>
        )}
        ...
        {contract.terms && contract.terms.length > 0 && (
          <View style={styles.notesSection}>
            <Text style={styles.notesTitle}>契約条項 / Terms & Conditions</Text>
