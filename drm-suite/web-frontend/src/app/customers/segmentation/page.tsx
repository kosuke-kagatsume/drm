    ...
    <div className="min-h-screen bg-gradient-to-br from-gray-50 via-white to-green-50 p-8">
      ...
      <div className="max-w-7xl mx-auto grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6 mb-8">
        ...
        <div className="bg-white rounded-xl p-6 shadow-sm border border-green-100 bg-green-50">
          ...
          <p className="text-xs text-green-600 mt-1">最重要顧客</p>
        </div>
        ...
        <div className="bg-white rounded-xl p-6 shadow-sm border border-gray-100">
          ...
          <p className="text-xs text-gray-600 mt-1">100点満点</p>
        </div>
        ...
        <div className="bg-white rounded-xl p-6 shadow-sm border border-red-100 bg-red-50">
          ...
          <p className="text-2xl font-bold text-red-700">{stats?.highRisk}社</p>
          <p className="text-xs text-red-600 mt-1">要フォロー</p>
        </div>
      </div>
      ...
      <div className="max-w-7xl mx-auto bg-white rounded-xl shadow-sm border border-gray-100">
          ...
          <div className="flex items-center justify-between">
            ...
            <div className="flex items-center gap-3">
              <select
                ...
                className="px-3 py-1.5 border border-gray-300 rounded-lg bg-white text-sm focus:outline-none focus:ring-2 focus:ring-green-500"
              >
        ...
        <div className="divide-y divide-gray-100">
          {filteredSegmentations.map((segmentation) => (
            <div key={segmentation.customerId} className="p-6 hover:bg-gray-50">
              {/* ヘッダー */}
                ...
                <div className="flex-1">
                  <div className="flex items-center gap-3 mb-2">
                    ...
                    <div className="text-sm text-gray-600">
                      総合スコア:{' '}
                      <span className="font-bold">{segmentation.score}点</span>
                    </div>
                  </div>
                </div>
              </div>
                ...
                <div className="lg:col-span-2 grid grid-cols-2 gap-4">
                  <div className="bg-blue-50 rounded-lg p-3">
                    ...
                    <p className="text-lg font-bold text-blue-900">
                      ¥
                      {(segmentation.metrics.totalRevenue / 1000000).toFixed(1)}
                      M
                    </p>
                  </div>
