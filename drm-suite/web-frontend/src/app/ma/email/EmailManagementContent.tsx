...
export default function EmailCommunicationPage() {
  ...
  const templates: EmailTemplate[] = [
    {
      ...
      previewText:
        'ご提案内容についてご不明な点がございましたらお気軽にご連絡ください',
      content: `
        <p>{{customer_name}} 様</p>
  ...
  const getStatusIcon = (status: EmailCampaign['status']) => {
    switch (status) {
      ...
      case 'sending':
        return <FiberManualRecord sx={{ fontSize: 16, color: '#4285f4' }} />;
      case 'sent':
        return <CheckCircle sx={{ fontSize: 16, color: '#34a853' }} />;
      case 'paused':
        return <Warning sx={{ fontSize: 16, color: '#fbbc04' }} />;
      default:
        return null;
    }
  };
  ...
  return (
    <Box sx={{ minHeight: '100vh', bgcolor: '#f5f5f5' }}>
            ...
            <Card>
              <CardContent>
                ...
                >
                  ...
                  <OpenInNew
                    sx={{ fontSize: 40, color: '#34a853', opacity: 0.3 }}
                  />
                </Box>
              </CardContent>
            </Card>
            ...
            <Card>
              <CardContent>
                ...
                >
                  ...
                  <TouchApp
                    sx={{ fontSize: 40, color: '#fbbc04', opacity: 0.3 }}
                  />
                </Box>
              </CardContent>
            </Card>
            ...
            <Card>
              <CardContent>
                ...
                >
                  ...
                  <Error
                    sx={{ fontSize: 40, color: '#ea4335', opacity: 0.3 }}
                  />
                </Box>
              </CardContent>
            </Card>
                  ...
                  <TableBody>
                    {campaigns.map((campaign) => (
                      <TableRow key={campaign.id}>
                        ...
                        <TableCell>
                          {campaign.performance.opens.toLocaleString()}
                        </TableCell>
                        <TableCell>
      ...
      >
        ...
        />
        <SpeedDialAction icon={<Send />} tooltipTitle="キャンペーン作成" />
        <SpeedDialAction icon={<PersonAdd />} tooltipTitle="宛先リスト作成" />
      </SpeedDial>
