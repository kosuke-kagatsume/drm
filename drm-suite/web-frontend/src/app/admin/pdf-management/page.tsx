        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="flex items-center justify-between h-16">
            <div className="flex items-center space-x-3">
              ...
              <div>
                <h1 className="text-xl font-bold text-gray-900">PDF管理システム</h1>
                <p className="text-sm text-gray-600">多テナント対応PDFテンプレート管理</p>
              </div>
            </div>
                  ...
                  return (
                    ...
                    >
                      <div className="flex items-start">
                        <Icon className={`w-5 h-5 mr-3 mt-0.5 ${isActive ? 'text-blue-600' : 'text-gray-400'}`} />
                        <div>
            ...
            <div className="mt-6 bg-white rounded-lg border p-4">
              ...
              <div className="space-y-3">
                <div className="flex justify-between">
                  <span className="text-sm text-gray-600">アクティブテンプレート</span>
          ...
          <div className="space-y-4">
            <div className="flex items-center justify-between">
              <div>
                ...
                <p className="text-xs text-gray-500">PDF にウォーターマークを追加</p>
              </div>
              <input
                type="checkbox"
            ...
            <div className="flex items-center justify-between">
              ...
              <input
                ...
                onChange={(e) => setSettings(prev => ({ ...prev, passwordProtection: e.target.checked }))}
                className="h-4 w-4 text-blue-600 border-gray-300 rounded focus:ring-blue-500"
              />
            </div>
            ...
            <div className="flex items-center justify-between">
              <div>
                ...
                <p className="text-xs text-gray-500">テンプレートを自動バックアップ</p>
              </div>
              <input
                type="checkbox"
          ...
          <div className="space-y-3">
            ...
            {[
              ...
              <div key={index} className="grid grid-cols-4 gap-4 items-center">
                ...
                <input type="checkbox" defaultChecked={perm.edit} className="h-4 w-4 text-blue-600" />
                <input type="checkbox" defaultChecked={perm.print} className="h-4 w-4 text-blue-600" />
                <input type="checkbox" defaultChecked={perm.download} className="h-4 w-4 text-blue-600" />
              </div>
            ))}
          </div>
        </div>
          ...
          <div className="space-y-4">
            <div className="grid grid-cols-2 gap-4">
              ...
              <div className="bg-white rounded p-3 text-center">
                ...
                <div className="text-xs text-gray-500">アクティブテンプレート</div>
              </div>
            </div>
