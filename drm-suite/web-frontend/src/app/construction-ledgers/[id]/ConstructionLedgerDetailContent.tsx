        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-6">
          <div className="flex items-center justify-between">
            ...
            <div className="flex items-center gap-3">
              ...
              <button
                onClick={() =>
                  router.push(`/construction-ledgers/${ledgerId}/edit`)
                }
            ...
            <div className="bg-white rounded-lg shadow p-6">
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                ...
                <div className="md:col-span-2">
                  ...
                  <p className="text-base font-medium text-gray-900 mt-1">
                    〒{ledger.constructionPostalCode}{' '}
                    {ledger.constructionPrefecture}
                  ...
                  <div>
                    ...
                    <div className="relative h-8 bg-gray-100 rounded-lg overflow-hidden">
                      ...
                      <div
                        ...
                        style={{
                          width: `${Math.min(
                            (ledger.actualCost.materialCost /
                              ledger.executionBudget.totalBudget) *
                              100,
                            100,
                          )}%`,
                  ...
                  <div>
                    ...
                    <div className="relative h-8 bg-gray-100 rounded-lg overflow-hidden">
                      <div
                        ...
                        style={{
                          width: `${Math.min(
                            (ledger.executionBudget.laborCost /
                              ledger.executionBudget.totalBudget) *
                              100,
                            100,
                          )}%`,
              ...
              <div className="bg-white rounded-lg shadow p-6">
                  ...
                  <div className="space-y-3">
                      ...
                      <div className="flex justify-between items-center mb-1">
                        ...
                        <span
                          className={`text-xs font-medium ${
                            ledger.costAnalysis.budgetVsActual
                              .materialVariance >= 0
                              ? 'text-green-600'
                              : 'text-red-600'
                          }`}
                    ...
                    <div>
                      <div className="flex justify-between items-center mb-1">
                        ...
                        <span
                          className={`text-xs font-medium ${
                            ledger.costAnalysis.budgetVsActual.laborVariance >=
                            0
                              ? 'text-green-600'
                              : 'text-red-600'
                          }`}
                    ...
                    <div>
                      <div className="flex justify-between items-center mb-1">
                        ...
                        >
                          {ledger.costAnalysis.budgetVsActual.expenseVariance >=
                          0
                            ? '+'
                            : ''}
                          ¥
                ...
                <div className="space-y-4">
                  <div className="flex justify-between items-center py-3 border-b">
                    ...
                    >
                      {ledger.costAnalysis.budgetVsActual.materialVariance >=
                      0 ? (
                  ...
                  >
                    ...
                    >
                      ...
                      ¥
                      {Math.abs(
                        ledger.costAnalysis.budgetVsActual.totalVariance,
                      ).toLocaleString()}{' '}
                      (
                      {ledger.costAnalysis.budgetVsActual.varianceRate.toFixed(
                        1,
                      )}
                      %)
                    </span>
                  ...
                  >
                    ...
                    >
                      {ledger.costAnalysis.profitAnalysis.profitVariance >=
                      0 ? (
                        <TrendingUp className="h-5 w-5" />
                      ) : (
                        <TrendingDown className="h-5 w-5" />
                      ...
                      (
                      {ledger.costAnalysis.profitAnalysis.profitVarianceRate.toFixed(
                        1,
                      )}
                      %)
                    </span>
                  ...
                  <div className="p-4 bg-yellow-50 rounded-lg">
                    ...
                    <div className="text-lg font-bold text-yellow-600">
                      {Math.max(
                        0,
                        Math.floor(
                          (new Date(ledger.scheduledEndDate).getTime() -
                            new Date().getTime()) /
                            (1000 * 60 * 60 * 24),
                        ),
                      )}
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                {ledger.estimateId && (
                  <div>
                    ...
                    <button
                      onClick={() =>
                        router.push(`/estimates/${ledger.estimateId}`)
                      }
                ...
                {ledger.contractId && (
                  <div>
                    ...
                    <button
                      onClick={() =>
                        router.push(`/contracts/${ledger.contractId}`)
                      }
                      className="text-sm text-blue-600 hover:text-blue-800 mt-1"
                    >
                      契約詳細を見る →
